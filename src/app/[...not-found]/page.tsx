...
export const metadata: Metadata = {
  ...
  description: "The page you’re looking for doesn’t exist. Maybe it was a typo, or maybe we haven’t built it yet.",
};

const NotFoundPage = () => (
  <main className="bg-[oklch(var(--color-brand-primary-soft))] min-h-[calc(100vh-174px)] flex items-center">
    <section className="w-full">
      <div className="max-w-[640px] mx-auto px-4 py-12 md:py-20 grid gap-6">
        <header className="grid gap-2">
          <p className="font-serif text-sm uppercase tracking-[0.18em] text-[oklch(var(--color-text-neutral-soft))]">
            404
          </p>
          <h1 className="font-serif text-h1 leading-tight tracking-tight text-[oklch(var(--color-text-strong))]">
            You&apos;ve run off course.
          </h1>
          <p className="text-body leading-relaxed text-[oklch(var(--color-text-neutral-soft))] max-w-prose">
            The page you&apos;re looking for doesn&apos;t exist. Maybe it was a typo,
